...
window.addEventListener('load', function() {
  ...
  if (adatok.length > 0) {
      ...
      let table = `<table class="table-style">
          <tr><th colspan="7">Elemek száma: ${adatok.length}, Matek átlag: ${avgMatematika.toFixed(2)}, Magyar átlag: ${avgMagyar.toFixed(2)}, Össz átlag: ${avgCombined.toFixed(2)}</th></tr>
